...
public final class ActivityCalculatorBinding implements ViewBinding {
  ...
  private ActivityCalculatorBinding(@NonNull LinearLayout rootView, @NonNull Button button0,
      ...
      @NonNull Button buttonAdd, @NonNull Button buttonDivide, @NonNull Button buttonEquals,
      @NonNull Button buttonMultiply, @NonNull Button buttonSubtract, @NonNull TextView result) {
  ...
  public static ActivityCalculatorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCalculatorBinding((LinearLayout) rootView, button0, button1, button2,
          button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonDivide,
          buttonEquals, buttonMultiply, buttonSubtract, result);
    }
